...
public class DBservice {
	...
	public void instaciaDB() {
		...
		OS os1 = new OS(null, null, null, Prioridade.ALTA, "Trocar fonte do notebook", Status.ANDAMENTO, t1, c1);
		OS os2 = new OS(null, null, null, Prioridade.BAIXA, "Trocar placa mãe", Status.ANDAMENTO, t2, c2);
		OS os3 = new OS(null, null, null, Prioridade.ALTA, "Formatar para linux", Status.ANDAMENTO, t3, c3);
		OS os4 = new OS(null, null, null, Prioridade.MEDIA, "Ativar antivirus", Status.ANDAMENTO, t4, c4);
		OS os5 = new OS(null, null, null, Prioridade.MEDIA, "Criar sistema full stack", Status.ANDAMENTO, t5, c5);
		OS os6 = new OS(null, null, null, Prioridade.BAIXA, "Trocar pasta térmica", Status.ANDAMENTO, t1, c1);
